...
class SeqRec(nn.Module):
    ...
    def seqs_correction(self, input_seqs, targets, changed_index, candidate_items):
        ...
        if torch.cuda.is_available():
            ...
            targets = target.to(torch.device('cuda'))
        ...
        while i < len(changed_target):
            ...
            changed_target = candidate_items[seqs_index][t_c_index]
            modified_targets[seqs_index] = changed_target
