...
class SeqDataCollector(object):
    ...
    def generate_train_dataloader_unidirect(self):
        ...
        for user, item_full_seq in self.userIdx2sequence.items():  # 遍历用户字典
            ...
            for sub_seq, mask, candidate_items in slide_window(item_train_seq, sub_seq_len, candidate_num):
    ...
    def generate_test_dataloader_unidirect(self):
        ...
        for user, item_full_seq in self.userIdx2sequence.items():
            ...
            sampled_negs = sampled_negs[:101]  # 100个负样本欸
            test_targets.append([item_full_seq[-1]] + list(sampled_negs))  # 长度为101
...
def slide_window(itemList, window_size, candidate_num):
    """
